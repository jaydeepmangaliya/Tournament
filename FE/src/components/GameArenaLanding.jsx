                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {tournaments.map((tournament, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -10 }}
                            className="relative overflow-hidden rounded-xl bg-gray-900 border border-gray-800 group"
                        >
        ...
        <section ref={ref} className="py-32 relative overflow-hidden bg-black">
            <div className="container mx-auto px-6 relative z-10">
                <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                    className="bg-gray-900 rounded-2xl border border-gray-800 overflow-hidden p-16 text-center"
                >
                    <motion.h2
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-4xl mx-auto relative">
                    <div className="absolute left-0 right-0 top-1/2 transform -translate-y-1/2 flex justify-between z-10">
                        <button
                            onClick={handlePrev}
                            className="w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-colors shadow-lg"
                        >
                    ...
                    <div className="overflow-hidden relative h-96">
                        <AnimatePresence custom={direction} initial={false}>
                            <motion.div
                                ...
                                transition={{ duration: 0.6 }}
                                className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-gray-900 rounded-xl border border-gray-800"
                            >
                                <div className="w-24 h-24 rounded-full bg-gray-800 mb-6 overflow-hidden flex items-center justify-center text-white text-3xl font-bold">
